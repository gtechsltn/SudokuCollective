...
namespace SudokuCollective.Test.TestCases.Payloads
{
    public class AnnonymousCheckRequestShould
    {
        ...
        public void Setup()
        {
            sut = TestObjects.GetValidAnnonymousCheckPayload();
        }
        ...
        [Test, Category("Payloads")]
        public void ThrowsExceptionWithInvalidIntLists()
        {
            // Arrange and Act

            // Assert
            Assert.Throws<ArgumentException>(() => TestObjects.GetInvalidAnnonymousCheckPayload());
        }
    }
}
